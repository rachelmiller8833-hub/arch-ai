...
export default function StepPrototypes({
  ...
  function handleDownloadPRD() {
    const lines: string[] = [
      ...
      `## Executive Summary`,
      ``,
      `This PRD was generated by a 5-agent AI architecture debate covering product structure, UX design, interaction engineering, cost analysis, and QA perspectives.`,
      ``,
      `---`,
      ``,
